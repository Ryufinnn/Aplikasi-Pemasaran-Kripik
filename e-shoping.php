...
if(session_is_registered('user_id'))
{
	...
	if (!empty($cek)){
		...
		//kalo udah lunas
			...
			$query=mysql_db_query($db,"insert into shoping(idshop,idbrg,iduser,tgl) values('$idshop','$idbrg','$iduser','$tgll')",$koneksi);
			$transaksi=mysql_db_query($db,"insert into pemesanan(idbrg,iduser,tgl,status) values('$idshop,idbrg','$iduser','$tanggal','proses')",$koneksi);
